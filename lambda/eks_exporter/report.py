"""Geração do relatório CLUSTER-INFO.md (Lambda, StringIO). Corpo idêntico ao CLI."""
import io
from datetime import datetime, timezone

from .aws_boto3 import _CAPTURE_FAILURES


def render_cluster_info(ctx):
    """Renderiza o CLUSTER-INFO.md a partir do contexto e devolve a string."""
